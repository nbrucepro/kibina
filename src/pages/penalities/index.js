...
import { penalitiesFromfir, setselectedmonth } from 'store/reducers/menu';
import {
  collection,
  // doc,
  // getDoc,
...
const Kuguza = () => {
  ...
  const getKuguza = async () => {
    // const q = query(penalitiesDb);
    // const q = loggedInusersm?.role === 0 ? query(penalitiesDb, where('nid', '==', loggedInusersm?.nid)) : query(penalitiesDb);
